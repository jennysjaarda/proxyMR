...
library(knitr)
knitr::include_graphics("assets/single_trait_model.png", error = FALSE)
```
...
In general, found that female estimates are on average larger than males (result of the paired t-test shown below).

```{r sex_het_m_vs_f, eval = ifelse(Sys.info()["sysname"]=="Linux", TRUE, FALSE), echo = FALSE}
