...
\begin{equation}
	 \; X_{p} = G_{i}\cdot {\beta_{x, i\rightarrow p} } + \epsilon \\
	 \; Y_{i} = G_{i}\cdot {\beta_{y, i\rightarrow i} } + \epsilon \\
	 \; Y_{p} = G_{i}\cdot {\beta_{y, i\rightarrow p} } + \epsilon \\
	 \; Y_{i} = \alpha_j\cdot X_{i} +\epsilon \\
	 \; X_{p} = \alpha_{x, am}\cdot X_{i{}} +\epsilon \\
	 \; Y_{p} = \alpha_{y, am}\cdot Y_{i{}} +\epsilon \\
	 \; Y_{p} = \alpha_{k}\cdot X_{i} +\epsilon
\end{equation}
