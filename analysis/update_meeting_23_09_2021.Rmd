...
yiyp_adj.DT <- proxyMR_MR_paths_summary_yiyp_adj %>% dplyr::select(exposure_description, outcome_description, exposure_sex, starts_with("yiyp_IVW"))

DT::datatable(yiyp_adj.DT, width = "100%") %>% formatRound(columns=c('YiXi_IV_exact_overlap', 'YiXi_IV_sig_overlap'), digits = 3)
