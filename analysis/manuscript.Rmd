...
max_C_plot <- ggplot2::ggplot(data = max_C_data, 
  ...
  ggplot2::geom_errorbar(
    ggplot2::aes(ymin = same_trait_corr_minus_MR_est - 1.96*corr_due_to_confounding_summ_SE, 
                 ymax = same_trait_corr_minus_MR_est + 1.96*corr_due_to_confounding_summ_SE),
    colour = "grey",
    width = 0
  ) +
  ggplot2::geom_errorbar(
    ggplot2::aes(xmin = corr_due_to_confounding_summ - 1.96*Z_prod_se, 
                 xmax = corr_due_to_confounding_summ + 1.96*Z_prod_se),
    colour = "grey",
    width = 0
  ) +
