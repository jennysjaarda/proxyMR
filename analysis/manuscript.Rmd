...
write.xlsx_wrapper(sig_confounders, file=supplementary_tables_file, sheetName="Supp Table 3 sig_confounders", append=TRUE, row.names=FALSE)
write.xlsx_wrapper(paths_summary, file=supplementary_tables_file, sheetName="Supp Table 4 paths_summary", append=TRUE, row.names=FALSE)
